            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form method = "POST" action=" {{url('/')}}/teachers/update/{{$teacher->id}}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        {{ csrf_field() }}
                        {{ method_field('PATCH') }}
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="name" name="name" required="required" class="form-control col-md-7 col-xs-12" value="{{ $teacher->name }}">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="initial_qualification_id">Initial Qualification<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="current_qualification_id">Current Qualification<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="dzongkhag_id" id="dzongkhagslist" required="required" onchange="populateSchools()" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="school_id" required="required" id="schoolslist" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="elective_subject_two_id">Subject 2<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="elective_subject_three_id">Subject 3
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="subject_three_id" required="required" class="form-control col-md-7 col-xs-12">
                       ...
                       <div class="form-group" id="contract_from">
                        ...
                        <fieldset>
                          <div class="control-group">
                            <div class="controls">
                              <div class="col-md-6 xdisplay_inputx form-group has-feedback">
                                <input type="text" class="form-control has-feedback-left" id="single_cal"  name="contract_from" aria-describedby="inputSuccess2Status" placeholder="dd/mm/yyyy" value="{{$teacher->contract_from}}">
                                <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                                <span id="inputSuccess2Status" class="sr-only">(success)</span>
                              </div>
                            </div>
                       ...
                       <div class="form-group" id="contract_to">
                        ...
                        <fieldset>
                          <div class="control-group">
                            <div class="controls">
                              <div class="col-md-6 xdisplay_inputx form-group has-feedback">
                                <input type="text" class="form-control has-feedback-left" id="single_cal" name="contract_to" aria-describedby="inputSuccess2Status" placeholder="dd/mm/yyyy" value="{{$teacher->contract_from}}" >
                                <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                                <span id="inputSuccess2Status" class="sr-only">(success)</span>
                              </div>
                            </div>
                       ...
                       <div class="form-group" >
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="remarks" name="remarks" required="required" class="form-control col-md-7 col-xs-12" value="{{$teacher->remarks}}" >
                        </div>
                      </div>
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         ...
                         @if($teacher->hometown==$hometown->id)
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         ...
                         @if($teacher->marital_status=='Single')
                          ...
                          <option value="Widow">Widow</option>
                           @elseif($teacher->marital_status=='Widow')
                          <option value="Single" selected>Single</option>
                          <option value="Married">Married</option>
                          <option value="Divorced">Divorced</option>
                          <option value="Widow">Widow</option>
