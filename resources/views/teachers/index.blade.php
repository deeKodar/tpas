                            ...
                            @foreach($teachers as $teacher)
                                <tr>
                                    ...
                                    <td class=" last">
                                        ...
                                        <a href="{{url('/')}}/teachers/{{$teacher->id}}/view/" class="btn btn-xs btn-success waves-effect waves-light" data-toggle="tooltip" data-placement="right" title="View Teacher Details"><i class="fa fa-eye fa-lg" aria-hidden="true"></i> View Detail</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
