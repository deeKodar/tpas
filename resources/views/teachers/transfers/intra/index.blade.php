    ...
    <div class="right_col" role="main">
        <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                       <h2>Intra Dzongkhag Transfer of Teachers: @if(isset($dzongkhag))<b><u>{{$dzongkhag->name}}</u></b>@endif dzongkhag</h2>
                            ...
                            @foreach($teachers as $teacher)
                                <tr>
                                    ...
                                    <td class=" last">
                                        ...
                                        <a href="{{ route('teachers.transfer.intra', ['id' => $teacher->id]) }}" class="btn btn-xs btn-warning waves-effect waves-light" data-toggle="tooltip" data-placement="left" title="Intra dzongkhag transfer"><i class="fa fa-pencil-square fa-lg" aria-hidden="true"></i> Change school</a>
