                  ...
                  <div class="x_content">
                    ...
                    <form method = "POST" action=" {{url('/')}}/users/store" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group" id="dzongkhags" style="display:none;">
                        ...
                        <select id="dzongkhags" class="form-control col-md-7 col-xs-12" onchange="populateSchools()">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <select class="form-control col-md-7 col-xs-12" id="schools" ><option disabled selected>Select School</option>
