                            ...
                            @foreach($roles as $role)
                                <tr>
                                    ...
                                    <td class=" last">
                                        ...
                                        <a href="{{url('/')}}/roles/{{$role->id}}/edit" class="btn btn-xs btn-warning waves-effect waves-light" data-toggle="tooltip" data-placement="left" title="Edit role"><i class="fa fa-pencil-square fa-lg" aria-hidden="true"></i> Edit</a>
