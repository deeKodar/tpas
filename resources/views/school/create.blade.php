                        ...
                        <div class="x_content">
                            ...
                            <form method = "POST" action=" {{ route('school.store') }} " id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        {!! Form::select('dzongkhag_id', (['0' => 'Select a Dzongkhag'] + $dzongkhags), null, ['class' => 'form-control']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        {!! Form::select('school_status_type_id', (['0' => 'Select a Dzongkhag'] + $dzongkhags), null, ['class' => 'form-control']) !!}
                                    </div>
                                </div>
